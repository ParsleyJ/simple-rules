...
public class NativeFacts {
    private NativeFacts(){} // don't instantiate
    ...
    public static <T1, T2> NativeFact binaryPredicate(Type type,
        ...
        return new NativeFact(type, module, name, Arrays.asList(var("X1"), var("X2")), (self, theta, other)->{
    ...
    public static <T1, T2, R> NativeFact binaryOperator(Type type,
        ...
        return new NativeFact(type, module, name, Arrays.asList(var("X1"), var("X2"), var("R")),
                ((self, theta, other) -> {
    ...
    public static <T, R> NativeFact unaryOperator(Type type,
        ...
        return new NativeFact(type, module, name, Arrays.asList(var("X"), var("R")), ((self, theta, other) -> {
            UnificationResult tempTheta = unify(theta.copy(), new StructImpl(type, self.toJavaList()), other);
            if (tempTheta.isFailure()) {
                return UnificationResult.FAILURE;
            }
    ...
    public static List<Term> nativeIntegerFacts() {
        ...
        result.add(unaryOperator(JavaType.Integer, "INT_LIB", "-", Integer.class, Integer.class, a -> -a));
        result.add(unaryOperator(JavaType.Integer, "INT_LIB", "abs", Integer.class, Integer.class, Math::abs));
        result.add(binaryOperator(JavaType.Integer, "INT_LIB", "+", Integer.class, Integer.class, Integer.class, Integer::sum));
        result.add(binaryOperator(JavaType.Integer, "INT_LIB", "-", Integer.class, Integer.class, Integer.class, (a, b) -> a - b));
        result.add(binaryOperator(JavaType.Integer, "INT_LIB", "*", Integer.class, Integer.class, Integer.class, (a, b) -> a * b));
        result.add(binaryOperator(JavaType.Integer, "INT_LIB", "%", Integer.class, Integer.class, Integer.class, (a, b) -> a % b));
        result.add(binaryOperator(JavaType.Integer, "INT_LIB", "/", Integer.class, Integer.class, Integer.class, (a, b) -> a / b));
        result.add(binaryOperator(JavaType.Integer, "INT_LIB", "min", Integer.class, Integer.class, Integer.class, Integer::min));
        result.add(binaryOperator(JavaType.Integer, "INT_LIB", "max", Integer.class, Integer.class, Integer.class, Integer::max));
        result.add(binaryPredicate(JavaType.Integer, "INT_LIB", ">", Integer.class, Integer.class, (a, b) -> a > b));
        result.add(binaryPredicate(JavaType.Integer, "INT_LIB", ">=", Integer.class, Integer.class, (a, b) -> a >= b));
        result.add(binaryPredicate(JavaType.Integer, "INT_LIB", "<", Integer.class, Integer.class, (a, b) -> a < b));
        result.add(binaryPredicate(JavaType.Integer, "INT_LIB", "<=", Integer.class, Integer.class, (a, b) -> a <= b));
